...
public abstract class ReadWriteModbusServices extends ReadOnlyModbusServices implements ModbusServices {

    @Override
    public WriteSingleCoilResponse writeSingleCoil(
            ModbusRequestContext context, int unitId, WriteSingleCoilRequest request) throws UnknownUnitIdException {

        ProcessImage processImage = getProcessImage(unitId).orElseThrow(() -> new UnknownUnitIdException(unitId));
    ...
    public WriteMultipleCoilsResponse writeMultipleCoils(
            ModbusRequestContext context, int unitId, WriteMultipleCoilsRequest request) throws UnknownUnitIdException {
    ...
    public MaskWriteRegisterResponse maskWriteRegister(
            ModbusRequestContext context, int unitId, MaskWriteRegisterRequest request) throws UnknownUnitIdException {
