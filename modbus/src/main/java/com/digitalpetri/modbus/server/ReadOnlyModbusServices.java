...
public abstract class ReadOnlyModbusServices implements ModbusServices {
    ...
    public ReadDiscreteInputsResponse readDiscreteInputs(
            ModbusRequestContext context, int unitId, ReadDiscreteInputsRequest request) throws UnknownUnitIdException {
    ...
    public ReadHoldingRegistersResponse readHoldingRegisters(
        ...
        byte[] registers = processImage.get(tx -> tx.readHoldingRegisters(readRegisters(address, quantity)));
    ...
    public ReadInputRegistersResponse readInputRegisters(
            ModbusRequestContext context, int unitId, ReadInputRegistersRequest request) throws UnknownUnitIdException {
        ...
        byte[] registers = processImage.get(tx -> tx.readInputRegisters(readRegisters(address, quantity)));
