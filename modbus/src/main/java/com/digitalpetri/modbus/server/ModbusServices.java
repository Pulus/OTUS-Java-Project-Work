...
public interface ModbusServices {
     ...
     */
    default ReadCoilsResponse readCoils(ModbusRequestContext context, int unitId, ReadCoilsRequest request)
    ...
    default ReadDiscreteInputsResponse readDiscreteInputs(
        ...
        throw new ModbusResponseException(FunctionCode.READ_DISCRETE_INPUTS, ExceptionCode.ILLEGAL_FUNCTION);
    }
    ...
    default ReadHoldingRegistersResponse readHoldingRegisters(
        ...
        throw new ModbusResponseException(FunctionCode.READ_HOLDING_REGISTERS, ExceptionCode.ILLEGAL_FUNCTION);
    }
    ...
    default ReadInputRegistersResponse readInputRegisters(
        ...
        throw new ModbusResponseException(FunctionCode.READ_INPUT_REGISTERS, ExceptionCode.ILLEGAL_FUNCTION);
    }
    ...
    default WriteSingleCoilResponse writeSingleCoil(
        ...
        throw new ModbusResponseException(FunctionCode.WRITE_SINGLE_COIL, ExceptionCode.ILLEGAL_FUNCTION);
    }
    ...
    default WriteSingleRegisterResponse writeSingleRegister(
        ...
        throw new ModbusResponseException(FunctionCode.WRITE_SINGLE_REGISTER, ExceptionCode.ILLEGAL_FUNCTION);
    }
    ...
    default WriteMultipleCoilsResponse writeMultipleCoils(
        ...
        throw new ModbusResponseException(FunctionCode.WRITE_MULTIPLE_COILS, ExceptionCode.ILLEGAL_FUNCTION);
    }
    ...
    default WriteMultipleRegistersResponse writeMultipleRegisters(
        ...
        throw new ModbusResponseException(FunctionCode.WRITE_MULTIPLE_REGISTERS, ExceptionCode.ILLEGAL_FUNCTION);
    }
    ...
    default MaskWriteRegisterResponse maskWriteRegister(
        ...
        throw new ModbusResponseException(FunctionCode.MASK_WRITE_REGISTER, ExceptionCode.ILLEGAL_FUNCTION);
    }
    ...
    default ReadWriteMultipleRegistersResponse readWriteMultipleRegisters(
        ...
        throw new ModbusResponseException(FunctionCode.READ_WRITE_MULTIPLE_REGISTERS, ExceptionCode.ILLEGAL_FUNCTION);
    }
     ...
     */
    static void checkRegisterRange(int functionCode, int address, int quantity) throws ModbusResponseException {
     ...
     * @throws ModbusResponseException if the combination of address and quantity are invalid.
     */
    static void checkBitRange(int functionCode, int address, int quantity) throws ModbusResponseException {
