...
public class ModbusRtuServer implements ModbusServer {
    ...
    public ModbusRtuServer(ModbusServerConfig config, ModbusRtuServerTransport transport, ModbusServices services) {
    ...
    protected ModbusRtuFrame handleModbusRtuFrame(
            ModbusRtuRequestContext context, int unitId, int fcb, ModbusRequestPdu requestPdu) throws Exception {
     ...
     */
    public static ModbusRtuServer create(ModbusRtuServerTransport transport, ModbusServices modbusServices) {
