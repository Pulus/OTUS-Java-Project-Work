...
public record ReadWriteMultipleRegistersRequest(
    ...
    @Override
    public int hashCode() {
        return Objects.hash(readAddress, readQuantity, writeAddress, writeQuantity, Arrays.hashCode(values));
    }

    @Override
    public String toString() {
        // note: overridden to give preferred representation of `values` bytes
        return new StringJoiner(", ", ReadWriteMultipleRegistersRequest.class.getSimpleName() + "[", "]")
