...
class ModbusRtuRequestFrameParserTest {
    ...
    private static final byte[] READ_COILS = new byte[] {0x01, 0x01, 0x00, 0x00, 0x00, 0x08, (byte) 0xCA, (byte) 0xFE};

    private static final byte[] WRITE_MULTIPLE_REGISTERS =
            new byte[] {0x01, 0x10, 0x00, 0x00, 0x00, 0x02, 0x04, 0x00, 0x01, 0x00, 0x02, (byte) 0x8B, (byte) 0x3A};
