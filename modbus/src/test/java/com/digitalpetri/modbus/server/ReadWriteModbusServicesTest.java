...
public class ReadWriteModbusServicesTest {
    ...
    void writeSingleCoil() throws Exception {
        ...
        for (int i = 0; i < 65536; i++) {
            ...
            services.writeSingleCoil(new TestModbusRequestContext(), 0, new WriteSingleCoilRequest(i, values[i]));
        }
    ...
    void writeMultipleCoils() throws Exception {
        ...
        while (remaining > 0) {
            ...
            services.writeMultipleCoils(
                    new TestModbusRequestContext(), 0, new WriteMultipleCoilsRequest(address, quantity, coils));
    ...
    void writeSingleRegister() throws Exception {
        ...
        for (int i = 0; i < 65536; i++) {
            ...
            services.writeSingleRegister(new TestModbusRequestContext(), 0, new WriteSingleRegisterRequest(i, value));
        }
    ...
    void writeMultipleRegisters() throws Exception {
        ...
        while (remaining > 0) {
            ...
            services.writeMultipleRegisters(
                    new TestModbusRequestContext(), 0, new WriteMultipleRegistersRequest(address, quantity, registers));
